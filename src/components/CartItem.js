    ...
    <div className='w-full min-h-[150px] flex items-center gap-x-4 '>
        ...
        <div className='w-full flex flex-col '>
          ...
          <div className=' flex gap-x-2 h-[36px]'>
            ...
            {/* item price  */}
            <div className='flex-1 flex items-center justify-around '>&#8377; {Math.round(price*83)}</div>
            {/* Final price */}
            <div className='flex-1 flex justify-end items-center text-primary font-medium'>&#8377; {Math.round(price*83)*amount}</div>
          </div>
        </div>
    </div>
  </div>;
